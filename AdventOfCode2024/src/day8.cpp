...
std::set<Coord> findAntiNodes(const std::vector<std::string> &inputData, const char c, const std::set<Coord> &coords) {
...
//            for (const auto &[a, b]: connectionSet) {
//                std::cout << "(" << a << ", " << b << ") ";
//            }
//            std::cout << std::endl;
...
//                std::cout << "1. find antinode for " << c << ": " << newAX << ", " << newAY << std::endl;
...
//                std::cout << "2. find antinode for " << c << ": " << newBX << ", " << newBY << std::endl;
...
int solverP1(const std::vector<std::string> &inputData) {
    ...
    for (const auto &[c, cSet]: inputMap) {
        const auto &antiNodes = findAntiNodes(inputData, c, cSet);
